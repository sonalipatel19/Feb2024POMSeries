...
public class AppConstants {
	...
	public static final String DEV_CONFIG_FILE_PATH = "./src/test/resources/config/dev.properties";
	public static final String QA_CONFIG_FILE_PATH = "./src/test/resources/config/qa.properties";
	public static final String STAGE_CONFIG_FILE_PATH = "./src/test/resources/config/stage.properties";
	public static final String UAT_CONFIG_FILE_PATH = "./src/test/resources/config/uat.properties";
